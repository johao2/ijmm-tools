...
2. `npm test` (`vitest run` — 172/172 unit tests passed, including registry, tool domains, analytics, advertising configuration, and structured-data safety)
3. `npm run build` (`next build` — 29 production routes compiled via Turbopack, including browser icon assets)
