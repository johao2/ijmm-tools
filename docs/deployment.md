...
2. `npm test` (`vitest run` — 97/97 unit tests passed, including registry, tool domains, analytics, advertising configuration, and structured-data safety)
3. `npm run build` (`next build` — 24 production routes compiled via Turbopack)
