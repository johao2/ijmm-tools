...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: "Convierte unidades de longitud, peso y masa, temperatura, área y volumen entre los sistemas métrico e imperial directamente en tu navegador.",
    shortDescription: "Convierte medidas métricas e imperiales al instante.",
    icon: "RefreshCw",
    status: "active",
    seo: {
      title: "Conversor de Unidades Online Gratis",
      description: "Convierte longitud, peso, temperatura, área y volumen entre unidades métricas e imperiales de forma rápida y precisa.",
      keywords: ["conversor de unidades", "convertir medidas", "metros a pies", "kilogramos a libras", "Celsius a Fahrenheit"],
